        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className="relative">
              <div className="md:before:bg-evolvetext before:absolute before:-top-20 before:-left-20 before:z-[-1] md:before:h-[250px] md:before:w-[60vw] md:before:max-w-[700px] md:before:bg-contain md:before:bg-no-repeat md:before:content-['']">
